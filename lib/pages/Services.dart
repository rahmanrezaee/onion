...
class Services extends StatefulWidget {
  ...
  const Services({Key key, this.openDrawer});
...
class _ServicesState extends State<Services> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        await Provider.of<DrawerScaffold>(
          context,
          listen: false,
          ...
          child: SingleChildScrollView(
              child: Column(
                ...
                Padding(
                  //
                  padding:
                      EdgeInsets.only(top: 20, bottom: 10, left: 10, right: 20),
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Row(children: [
                          ...
                          Expanded(
                            ...
                            child: Column(
                                ...
                                children: [
                                  Text(
                                      "Like and Idea? Bid and be a part of it!",
                                      style: TextStyle(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 13)),
                                  Text(
