...
class BidOnIdeaPage extends StatefulWidget {
  static const routeName = "BidAnIdea";

  @override
  _BidOnIdeaPageState createState() => _BidOnIdeaPageState();
}

class _BidOnIdeaPageState extends State<BidOnIdeaPage> {
