...
class _MapRangeColorMappingPageState extends SampleViewState {
  ...
  Widget build(BuildContext context) {
    return Consumer<AnalyticsProvider>(
      builder: (BuildContext context, value, Widget child) {
        ...
        // value.items.map((e) {
        //   _worldPopulationDensityDetails.add(
        //     _CountryDensityModel('${e.name}', 26337),
        //   );
        // });
  ...
  Widget _getMapsWidget(List<CountryDensityModel> myList) {
                        ...
                        layers: <MapLayer>[
                          MapShapeLayer(
                            ...
                            delegate: MapShapeLayerDelegate(
                              ...
                              shapeDataField: 'name',
                              dataCount: myList.length,
                              primaryValueMapper: (int index) {
                                return myList[index].countryName;
                              },

                              shapeColorValueMapper: (int index) {
                                return myList[index].density >= 250
                                    ? thirdPurple
                                    : firstPurple;
                              },
